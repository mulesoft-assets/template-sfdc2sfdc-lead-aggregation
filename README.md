...
As implemented, it gets leads from two instances of Salesforce, compares by the email address of the leads, and generates a CSV file which shows lead in A, lead in B, and leads in A and B. The report is then send as email to a configured group of email addresses.
...
# Run it! <a name="runit"/>
Simple steps to get Salesforce to Salesforce Lead Aggregation running.
