...
# Anypoint Template: Salesforce to Salesforce Lead Aggregation	
...
Once your app is all set and started, supposing you choose as domain name `sfdcleadaggregation` to trigger the use case you just need to browse to `http://sfdcleadaggregation.cloudhub.io/generatereport` and the report will be sent to the emails configured.
...
+ mail.subject `Salesforce Leads Report`
+ mail.body `Leads report comparing leads from Salesforce Accounts`
...
1. Leads only in Salesforce A
2. Leads only in Salesforce B
3. Leads in both Salesforce A and Salesforce B
